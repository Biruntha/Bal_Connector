...
public connector ClientConnector (string accessKeyId, string secretAccessKey,
    ...
    action request (http:Request requestMsg, string httpVerb, string requestURI, string payload) (http:Response) {
        ...
        system:println("11111111111111111111");
        ...
        system:println("222222222222222");
